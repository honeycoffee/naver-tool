...
** 작업정보의 진행상태가 "완료", "제외" 인 경우에는 수정 불가능.
...
** 작업정보의 진행상태가 "완료", "제외" 인 경우에는 수정 불가
...
==== Request
[cols="1,3"]
include::{snippets}/fare/getBaseFare/request-parameters.adoc[]

===== Request HTTP Example
include::{snippets}/fare/getBaseFare/http-request.adoc[]

==== Response
[cols="2,^1,4"]
include::{snippets}/fare/getBaseFare/response-fields.adoc[]

===== Response HTTP Example
include::{snippets}/fare/getBaseFare/http-response.adoc[]
...
==== Request
[cols="1,3"]
include::{snippets}/fare/selectIgnoredFareRuleList/request-parameters.adoc[]

===== Request HTTP Example
include::{snippets}/fare/selectIgnoredFareRuleList/http-request.adoc[]

==== Response
[cols="2,^1,4"]
include::{snippets}/fare/selectIgnoredFareRuleList/response-fields.adoc[]

===== Response HTTP Example
include::{snippets}/fare/selectIgnoredFareRuleList/http-response.adoc[]

&#160;

[[ignoredFareRule-info]]
=== 예외 요금 룰 상세정보
예외 요금 룰을 가져온다

==== Request
[cols="1,3"]
include::{snippets}/fare/getIgnoredFare/path-parameters.adoc[]

===== Request HTTP Example
include::{snippets}/fare/getIgnoredFare/http-request.adoc[]

==== Response
[cols="2,^1,4"]
include::{snippets}/fare/getIgnoredFare/response-fields.adoc[]

===== Response HTTP Example
include::{snippets}/fare/getIgnoredFare/http-response.adoc[]
...
==== Request
[cols="1,3"]
include::{snippets}/fare/fareTask/path-parameters.adoc[]

===== Request HTTP Example
- 작업ID 조회 : /v1/ntool/api/info/fareTask/1
include::{snippets}/fare/fareTask/http-request.adoc[]

==== Response
[cols="2,^1,4"]
include::{snippets}/fare/fareTask/response-fields.adoc[]

===== Response HTTP Example
include::{snippets}/fare/fareTask/http-response.adoc[]
...
==== Request HTTP Example
include::{snippets}/fare/fareSchema/http-request.adoc[]

==== Response
[cols="2,^1,4"]
include::{snippets}/fare/fareSchema/response-fields.adoc[]
