...
public class ApiExceptionHandler {
	...
	public CommonOutput httpStatus400(MissingServletRequestParameterException e) {
		return new CommonOutput(ResultCode.PARAMETER_ERROR.getApiErrorCode(),
	...
	public CommonOutput accessDeniedExceptionHandle(AccessDeniedException e) {
		return new CommonOutput(ResultCode.ACCESS_DENIED.getApiErrorCode(),
	...
	public CommonOutput httpStatus404(NoHandlerFoundException e) {
		return new CommonOutput(ResultCode.PAGE_NOT_FOUND_ERROR.getApiErrorCode(),
			ResultCode.PAGE_NOT_FOUND_ERROR.getDisplayMessage());
	}
	...
	public CommonOutput authTokenExpireExceptionHandle(TokenExpiredException e) {
		return new CommonOutput(ResultCode.AUTH_TOKEN_EXPIRED.getApiErrorCode(),
	...
	public CommonOutput authTokenDecodeExceptionHandle(JWTDecodeException e) {
		return new CommonOutput(ResultCode.AUTH_TOKEN_DECODE_ERROR.getApiErrorCode(),
	...
	public CommonOutput authTokenVerificationExceptionHandle(JWTVerificationException e) {
		return new CommonOutput(ResultCode.AUTH_TOKEN_VALID_ERROR.getApiErrorCode(),
	...
	public CommonOutput authExceptionhandle(AccessTokenNotFoundException e) {
		return new CommonOutput(ResultCode.AUTH_TOKEN_EMPTY.getApiErrorCode(),
