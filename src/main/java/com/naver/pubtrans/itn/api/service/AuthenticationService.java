...
public class AuthenticationService {
	...
	public AuthenticationOutputVo getMemberTokenInfo(AuthenticationInputVo authenticationInputVo) {
		...
		AuthenticationOutputVo authenticationOutputVo = authenticationRepository.getMemberTokenInfo(authenticationInputVo);
	...
	public String createAccessToken(String refreshToken)
		...
		String[] memberAuthenticationArray = memberService.getMemberAuthorityIdArray(memberSearchVo);

		String accessToken = jwtAdapter.createToken(memberOutputVo, memberAuthenticationArray, ChronoUnit.SECONDS,
